...
public class ActionRefreshOfflineInfoSelected extends Action {
	...
	public ActionRefreshOfflineInfoSelected(final PrefPageMapProviders prefPageMapFactories) {
		...
		setImageDescriptor(Activator.getImageDescriptor(Messages.App_Image_RefreshSelected));
		setDisabledImageDescriptor(Activator.getImageDescriptor(Messages.App_Image_RefreshSelected_Disabled));
	...
	@Override
	public void run() {
		fPrefPageMapFactories.actionRefreshOfflineInfo(true);
	}
