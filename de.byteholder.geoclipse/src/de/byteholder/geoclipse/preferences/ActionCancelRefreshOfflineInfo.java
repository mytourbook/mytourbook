...
public class ActionCancelRefreshOfflineInfo extends Action {
	...
	public ActionCancelRefreshOfflineInfo(final PrefPageMapProviders prefPageMapFactories) {
		...
		setImageDescriptor(Activator.getImageDescriptor(Messages.App_Image_Cancel));
		setDisabledImageDescriptor(Activator.getImageDescriptor(Messages.App_Image_Cancel_Disabled));
