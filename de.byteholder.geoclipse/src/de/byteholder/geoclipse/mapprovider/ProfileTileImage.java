...
//			brtAlpha = brtTileFactory.getProfileAlpha();
	...
	public void setBackgroundColor(final int backgroundColor) {
		...
		final byte dstBlue = (byte) ((backgroundColor & 0xFF0000) >> 16);
		final byte dstGreen = (byte) ((backgroundColor & 0xFF00) >> 8);
		final byte dstRed = (byte) ((backgroundColor & 0xFF) >> 0);
		...
		for (int dstY = 0; dstY < dstHeight; dstY++) {
			...
			for (int dstX = 0; dstX < dstWidth; dstX++) {
				...
				dstData[dataIndex] = dstBlue;
				dstData[dataIndex + 1] = dstGreen;
				dstData[dataIndex + 2] = dstRed;
			}
		}
