...
public class PrefPagePhotoImageCache extends PreferencePage implements IWorkbenchPreferencePage {
	...
	protected void performDefaults() {
		...
		_spinnerNumberOfImages.setSelection(_prefStore.getDefaultInt(//
				IPhotoPreferences.PHOTO_THUMBNAIL_IMAGE_CACHE_SIZE));

		_spinnerNumberOfOriginalImages.setSelection(_prefStore.getDefaultInt(//
				IPhotoPreferences.PHOTO_ORIGINAL_IMAGE_CACHE_SIZE));
	...
	private void saveState() {
		...
		int oldCacheSize = _prefStore.getInt(IPhotoPreferences.PHOTO_THUMBNAIL_IMAGE_CACHE_SIZE);

		if (oldCacheSize != newCacheSize) {
			_prefStore.setValue(IPhotoPreferences.PHOTO_THUMBNAIL_IMAGE_CACHE_SIZE, newCacheSize);
		...
		oldCacheSize = _prefStore.getInt(IPhotoPreferences.PHOTO_ORIGINAL_IMAGE_CACHE_SIZE);

		if (oldCacheSize != newCacheSize) {
			_prefStore.setValue(IPhotoPreferences.PHOTO_ORIGINAL_IMAGE_CACHE_SIZE, newCacheSize);
