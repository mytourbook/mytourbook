...
public class Messages extends NLS {
	...
	private static final String	BUNDLE_NAME	= "net.tourbook.photo.internal.messages";				//$NON-NLS-1$
	...
	public static String		Pic_Dir_Label_ImageLoadingFailed_FileNotAvailable;
