[Setup]
AppName=MyTourbook
AppVerName=MyTourbook 9.07.0
AppCopyright=MyTourbook Contributors 2005, 2009
AppID={{37852811-BC7D-411C-8122-E69CCA892582}

LicenseFile=M:\mytourbook TRUNK\net.tourbook\gpl.txt

OutputDir=m:\MyTourbook Product\9.07.0
OutputBaseFilename=mytourbook_9.07.0.win32.win32.x86.setup

DefaultGroupName=MyTourbook
DefaultDirName={pf}\MyTourbook

VersionInfoVersion=9.07.0
...
[Files]
Source: m:\MyTourbook Product\9.07.0\mytourbook_9.07.0.win32.win32.x86\mytourbook\*; DestDir: {app}; Flags: recursesubdirs; Tasks: ; Languages:
