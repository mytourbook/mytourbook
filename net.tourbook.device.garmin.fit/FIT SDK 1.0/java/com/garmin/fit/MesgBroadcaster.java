...
public class MesgBroadcaster implements MesgListener {
   ...
   private final List<TrainingGoalsMesgListener> trainingGoalsMesgListeners;
   ...
   public MesgBroadcaster(Decode decode) {
      ...
      trainingGoalsMesgListeners = new ArrayList<TrainingGoalsMesgListener>();
   ...
   public void addListener(TrainingGoalsMesgListener trainingGoalsMesgListener) {
      trainingGoalsMesgListeners.add(trainingGoalsMesgListener);
   }
   ...
   public void onMesg(final Mesg mesg) {
      ...
      switch (mesg.getNum()) {
         ...
         case MesgNum.TRAINING_GOALS:
            final TrainingGoalsMesg trainingGoalsMesg = new TrainingGoalsMesg(mesg);
            for (final TrainingGoalsMesgListener mesgListener : trainingGoalsMesgListeners)
               mesgListener.onMesg(trainingGoalsMesg);
            break;
