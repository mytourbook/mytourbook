...
class Profile
{
   public:
      ...
      static const Profile::MESG* Profile::GetMesg(FIT_UINT16 num);
      static const Profile::MESG* Profile::GetMesg(string name);
      static const FIT_UINT16 Profile::GetFieldIndex(FIT_UINT16 mesgNum, FIT_UINT8 fieldNum);
      static const FIT_UINT16 GetFieldIndex(string mesgName, string fieldName);
      static const Profile::FIELD* Profile::GetField(FIT_UINT16 mesgNum, FIT_UINT8 fieldNum);
      static const Profile::FIELD* Profile::GetField(string mesgName, string fieldName);
};
