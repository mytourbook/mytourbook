...
public class ActionSynchWithTour extends Action {
	...
	public ActionSynchWithTour(OSMView mapView) {
		...
		setImageDescriptor(Activator.getImageDescriptor(Messages.image__synch_with_tour));
		setDisabledImageDescriptor(Activator.getImageDescriptor(Messages.image__synch_with_tour_disabled));
	}
