...
public class xActionSynchChartVertical extends Action {

	private SynchedChartView	resultView;

	public xActionSynchChartVertical(SynchedChartView resultView) {
		...
		setImageDescriptor(TourbookPlugin.getImageDescriptor("synch-graph-vertical.gif"));
	}
