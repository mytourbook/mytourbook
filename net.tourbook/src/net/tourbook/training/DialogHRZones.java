...
//		btnOK.setText(Messages.App_Action_Save);
	...
	private void createHrZone(final int minValue, final int maxValue, final String zoneName) {
...
//		}
	...
	private void updateUIFromModel() {
		...
		if (_hrZones.size() == 0) {
			...
			createHrZone(Integer.MIN_VALUE, 60, Messages.HR_Zone_01_060_Moderate);
			createHrZone(60, 70, Messages.HR_Zone_01_070_FatBurning);
			createHrZone(70, 80, Messages.HR_Zone_01_080_Aerobic);
			createHrZone(80, 90, Messages.HR_Zone_01_090_Anaerobic);
			createHrZone(90, Integer.MAX_VALUE, Messages.HR_Zone_01_100_Maximum);
