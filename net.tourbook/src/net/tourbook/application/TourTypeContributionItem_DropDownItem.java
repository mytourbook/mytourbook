...
public class TourTypeContributionItem_DropDownItem extends CustomControlContribution {
	...
	public TourTypeContributionItem_DropDownItem() {
		this(ID);
	}

	protected TourTypeContributionItem_DropDownItem(final String id) {
		super(id);
	}
...
//		_tourTypeToolBar.setBackground(Display.getCurrent().getSystemColor(SWT.COLOR_RED));
		...
		_tourTypeToolBar.addKeyListener(new KeyListener() {
			@Override
