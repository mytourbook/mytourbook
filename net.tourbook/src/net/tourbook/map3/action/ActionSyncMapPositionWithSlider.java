...
public class ActionSyncMapPositionWithSlider extends Action {

	private Map3View	_map3View;

	public ActionSyncMapPositionWithSlider(final Map3View mapView) {
	...
	@Override
	public void run() {
		_map3View.actionSynchMapPositionWithSlider();
	}
