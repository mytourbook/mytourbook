...
//																		};
	...
	public void checkTrackRecreation(final TourTrackConfig previousConfig) {
		...
		if (previousConfig == null) {
			...
			final boolean backupIsAltitudeOffset = previousConfig.isAbsoluteOffset;
			final int backupAltitudeOffsetDistance = previousConfig.altitudeVerticalOffset;
			final boolean backupIsAbsoluteAltitudeMode = previousConfig.altitudeMode == WorldWind.ABSOLUTE;
			...
			final boolean isAbsoluteAltitudeNotModified = backupIsAltitudeOffset == isAbsoluteOffset
