...
public class ActionShowPOI extends Action {
	...
	public ActionShowPOI(final Map2View mapView) {
		...
		setImageDescriptor(TourbookPlugin.getImageDescriptor(Messages.Image_Action_POI));
		setDisabledImageDescriptor(TourbookPlugin.getImageDescriptor(Messages.Image_Action_POI_Disabled));
	}
