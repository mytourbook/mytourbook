...
public class ActionSearchOptions extends ContributionItem {
	...
	public void fill(final ToolBar toolbar, final int index) {
		...
		if (_actionToolItem == null && toolbar != null) {
			...
			_slideoutSearchOptions = new SlideoutSearchOptions(_parent, _toolBar, _state, _searchView);
		}
	}
	...
	private void onSelect() {
		...
		if (_slideoutSearchOptions.isToolTipVisible() == false) {
			...
			_slideoutSearchOptions.close();
		}
	}

	private void openSlideout(final Rectangle itemBounds, final boolean isOpenDelayed) {

		_slideoutSearchOptions.open(itemBounds, isOpenDelayed);
	}
