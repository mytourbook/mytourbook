...
//				SortField sortField[] = { new SortField("cat", SortField.STRING), SortField.FIELD_SCORE };
//				Sort sort = new Sort(sortField);
//
//				Query q = whatever;
//
//				TopFieldCollector tfc = TopFieldCollector.create(sort, 1000, true, true, true, true);
