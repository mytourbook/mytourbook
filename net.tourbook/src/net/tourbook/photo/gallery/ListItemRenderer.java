 ...
 * </p>
 * <p>
 * Decorator images can be set with {@link GalleryMTItem#setData(String, Object)}
...
public class ListItemRenderer extends AbstractGalleryItemRenderer {
	 ...
	 * int, int, int, int, int)
	 */
	public void draw(GC gc, GalleryMTItem item, int index, int x, int y,
	 ...
	 * font is used.
	 * 
	 * @deprecated Use {@link GalleryMT#setFont(Font)} or
	 *             {@link GalleryMTItem#setFont(Font)} instead.
	 * @return the font
	 */
