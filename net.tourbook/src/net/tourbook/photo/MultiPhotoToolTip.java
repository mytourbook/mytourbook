...
public class MultiPhotoToolTip extends ToolTip {
...
//	private Font					_boldFont;
	...
	public MultiPhotoToolTip(final Control control) {
	...
	protected Composite createToolTipContentArea(final Event event, final Composite parent) {
		 ...
		 */
		_bgColor = _tourChart.getBackground();
		_fgColor = _tourChart.getForeground();
...
//		label.pack();
	...
	private void createUI_PhotoImage(final Composite parent) {
		...
		try {
			...
			final int imageCanvasHeight = (int) (PhotoLoadManager.IMAGE_SIZE_THUMBNAIL / _tourChart.getItemRatio());
...
//					.indent(0, 5)
	...
	public Point getLocation(final Point tipSize, final Event event) {
		...
		final int galleryHeight = _tourChart.getBounds().height;
...
//		final Point ttDisplay = _gallery.toDisplay(ttPosX, ttPosY + tipHeight);
		final Point galleryDisplay = _tourChart.toDisplay(0, 0);
