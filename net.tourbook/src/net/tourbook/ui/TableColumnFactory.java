...
public abstract class TableColumnFactory {
	...
	public static final TableColumnFactory	RECORDING_TIME		= new TableColumnFactory() {
																	...
																	public TableColumnDefinition createColumn(	final ColumnManager columnManager,
																		...
																		final TableColumnDefinition colDef = new TableColumnDefinition(columnManager,
																				"recordingTime", SWT.TRAIL); //$NON-NLS-1$
	...
	public static final TableColumnFactory	DRIVING_TIME		= new TableColumnFactory() {
																	...
																	public TableColumnDefinition createColumn(	final ColumnManager columnManager,
																		...
																		final TableColumnDefinition colDef = new TableColumnDefinition(columnManager,
																				"drivingTime", SWT.TRAIL); //$NON-NLS-1$
	...
	public static final TableColumnFactory	DISTANCE			= new TableColumnFactory() {
																	...
																	public TableColumnDefinition createColumn(	final ColumnManager columnManager,
																		...
																		final TableColumnDefinition colDef = new TableColumnDefinition(columnManager,
																				"distance", SWT.TRAIL); //$NON-NLS-1$

																		colDef.setColumnLabel(Messages.ColumnFactory_distance_label
																				+ " (" + UI.UNIT_LABEL_DISTANCE + ")"); //$NON-NLS-1$ //$NON-NLS-2$
	...
	public static final TableColumnFactory	ALTITUDE_UP			= new TableColumnFactory() {
																	...
																	public TableColumnDefinition createColumn(	final ColumnManager columnManager,
																		...
																		final TableColumnDefinition colDef = new TableColumnDefinition(columnManager,
																				"altitudeUp", SWT.TRAIL); //$NON-NLS-1$

																		colDef.setColumnLabel(Messages.ColumnFactory_altitude_up_label
																				+ " (" + UI.UNIT_LABEL_ALTITUDE + ")"); //$NON-NLS-1$ //$NON-NLS-2$
	...
	public static final TableColumnFactory	ALTITUDE_UP_H		= new TableColumnFactory() {
																	...
																	public TableColumnDefinition createColumn(	final ColumnManager columnManager,
																		...
																		final TableColumnDefinition colDef = new TableColumnDefinition(columnManager,
																				"altitudeUpH", SWT.TRAIL); //$NON-NLS-1$

																		colDef.setColumnLabel(Messages.ColumnFactory_altitude_up_label
																				+ " (" + unitLabel + ")"); //$NON-NLS-1$ //$NON-NLS-2$
	...
	public static final TableColumnFactory	ALTITUDE_DOWN		= new TableColumnFactory() {
																	...
																	public TableColumnDefinition createColumn(	final ColumnManager columnManager,
																		...
																		final TableColumnDefinition colDef = new TableColumnDefinition(columnManager,
																				"altitudeDown", SWT.TRAIL); //$NON-NLS-1$
	...
	public static final TableColumnFactory	ALTITUDE_DOWN_H		= new TableColumnFactory() {
																	...
																	public TableColumnDefinition createColumn(	final ColumnManager columnManager,
																		...
																		final TableColumnDefinition colDef = new TableColumnDefinition(columnManager,
																				"altitudeDownH", SWT.TRAIL); //$NON-NLS-1$
																		...
																		colDef.setLabelProvider(new CellLabelProvider() {
																			...
																			public void update(final ViewerCell cell) {
																				...
																				if (importRawDataFile != null) {
																					cell.setText(new File(importRawDataFile).getParentFile()
																							.getPath());
																				}
																			}
																		});
