 ...
 */
public class ActionDeleteTourMenu extends Action implements IMenuCreator {
	...
	private void fillMenu(final Menu menu) {
		...
		final ActionContributionItem item = new ActionContributionItem(_actionDeleteTourMenu2);
		item.fill(menu, -1);
	}
