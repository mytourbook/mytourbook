...
//		fTextEndLocation.setEnabled(canEditTour);
	...
	private boolean saveTourWithoutConfirmation() {
		...
		TourManager.firePropertyChange(TourManager.TOUR_PROPERTIES_CHANGED, modifiedTour, TourDataEditorView.this);
