...
public class ActionViewSettings extends ContributionItem {
	...
	private SlideoutViewSettings	_slideoutViewSettings;
	...
	public ActionViewSettings(final TourDataEditorView tourEditorView, final Control parent) {
	...
	public void fill(final ToolBar toolbar, final int index) {
		...
		if (_actionToolItem == null && toolbar != null) {
			...
			_slideoutViewSettings = new SlideoutViewSettings(_parent, _toolBar, _state, _tourEditorView);
		}
	}
	...
	private void onSelect() {
		...
		if (_slideoutViewSettings.isToolTipVisible() == false) {
