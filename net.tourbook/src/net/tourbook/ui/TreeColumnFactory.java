...
public abstract class TreeColumnFactory {
	...
	public static final TreeColumnFactory	TOUR_TAGS	= new TreeColumnFactory() {
		...
		public TreeColumnDefinition createColumn(final ColumnManager columnManager, final PixelConverter pixelConverter) {
			...
			colDef.setLabel(Messages.ColumnFactory_tour_tag_label);
			colDef.setText(Messages.ColumnFactory_tour_tag_label);
			colDef.setToolTipText(Messages.ColumnFactory_tour_tag_tooltip);
			colDef.setWidth(pixelConverter.convertWidthInCharsToPixels(20));
