...
public class ActionRefreshOfflineInfoAll extends Action {
	...
	public ActionRefreshOfflineInfoAll(final PrefPageMapProviders prefPageMapFactories) {
		...
		setImageDescriptor(TourbookPlugin.getImageDescriptor(Messages.App_Image_RefreshAll));
		setDisabledImageDescriptor(TourbookPlugin.getImageDescriptor(Messages.App_Image_RefreshAll_Disabled));
	...
	@Override
	public void run() {
		_prefPageMapFactories.actionRefreshOfflineInfo(false);
	}
