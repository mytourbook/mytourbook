...
public class ActionZoomOutToMinZoom extends Action {
	...
	public ActionZoomOutToMinZoom(final IMapDefaultActions mapActionProvider) {
		...
		setImageDescriptor(TourbookPlugin.getImageDescriptor(Messages.Image_Action_ZoomOutToMinZoom));
		setDisabledImageDescriptor(TourbookPlugin.getImageDescriptor(Messages.Image_Action_ZoomOutToMinZoom_Disabled));
	}
