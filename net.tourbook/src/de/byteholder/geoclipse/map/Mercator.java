...
//	private GeoLon				fLong2			= new GeoLon();
	...
	public static double xToLong(final int x, final double radius) {
		...
		/*
		 * The user could have panned around the world a lot of times. Lat long goes from -180 to
		 * 180. So every time a user gets to 181 we want to subtract 360 degrees. Every time a user
