...
void Field::SetSTRINGValue(string value, FIT_UINT8 index)
{
   ...
   switch (profile->fields[profileIndex].type)
   {
      ...
      case FIT_BASE_TYPE_SINT8:
         {
            stringstream ss;
            FIT_SINT8 sint8Value;
            ss << value;
            ss >> sint8Value;
            SetSINT8Value(sint8Value, index);
            break;
         }
      ...
      case FIT_BASE_TYPE_UINT8:
         {
            stringstream ss;
            FIT_UINT8 uint8Value;
            ss << value;
            ss >> uint8Value;
            SetUINT8Value(uint8Value, index);
            break;
         }
      ...
      case FIT_BASE_TYPE_UINT8Z:
         {
            stringstream ss;
            FIT_UINT8Z uint8zValue;
            ss << value;
            ss >> uint8zValue;
            SetUINT8ZValue(uint8zValue, index);
            break;
         }
      ...
      case FIT_BASE_TYPE_SINT16:
         {
            stringstream ss;
            FIT_SINT16 sint16Value;
            ss << value;
            ss >> sint16Value;
            SetSINT16Value(sint16Value, index);
            break;
         }
      ...
      case FIT_BASE_TYPE_UINT16:
         {
            stringstream ss;
            FIT_UINT16 uint16Value;
            ss << value;
            ss >> uint16Value;
            SetUINT16Value(uint16Value, index);
            break;
         }
      ...
      case FIT_BASE_TYPE_UINT16Z:
         {
            stringstream ss;
            FIT_UINT16Z uint16zValue;
            ss << value;
            ss >> uint16zValue;
            SetUINT16ZValue(uint16zValue, index);
            break;
         }
      ...
      case FIT_BASE_TYPE_SINT32:
         {
            stringstream ss;
            FIT_SINT8 sint32Value;
            ss << value;
            ss >> sint32Value;
            SetSINT32Value(sint32Value, index);
            break;
         }
      ...
      case FIT_BASE_TYPE_UINT32Z:
         {
            stringstream ss;
            FIT_UINT32Z uint32zValue;
            ss << value;
            ss >> uint32zValue;
            SetUINT32ZValue(uint32zValue, index);
            break;
         }
      ...
      case FIT_BASE_TYPE_FLOAT32:
         {
            ...
            ss << value;
            ss >> float32Value;
            SetFLOAT32Value(float32Value, index);
            break;
         }
         break;
      ...
      case FIT_BASE_TYPE_FLOAT64:
         {
            ...
            ss << value;
            ss >> float64Value;
            SetFLOAT64Value(float64Value, index);
            break;
         }
