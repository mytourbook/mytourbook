...
static const Profile::FIELD sdmProfileFields[] =
{
   { 0, "message_index", "", 1, 0, 0, 254, 132 },
   { 0, "enabled", "", 1, 0, 0, 0, 0 },
   { 0, "sdm_ant_id", "", 1, 0, 0, 1, 139 },
   { 0, "sdm_cal_factor", "%", 10, 0, 0, 2, 132 },
   { 0, "odometer", "m", 100, 0, 0, 3, 134 },
   { 0, "speed_source", "", 1, 0, 0, 4, 0 },
};
...
static const Profile::FIELD bikeProfileFields[] =
{
   ...
   { 0, "name", "", 1, 0, 0, 0, 7 },
   { 0, "sport", "", 1, 0, 0, 1, 0 },
   { 0, "sub_sport", "", 1, 0, 0, 2, 0 },
   { 0, "odometer", "m", 100, 0, 0, 3, 134 },
   { 0, "bike_spd_ant_id", "", 1, 0, 0, 4, 139 },
   { 0, "bike_cad_ant_id", "", 1, 0, 0, 5, 139 },
   { 0, "bike_spdcad_ant_id", "", 1, 0, 0, 6, 139 },
   { 0, "bike_power_ant_id", "", 1, 0, 0, 7, 139 },
   { 0, "custom_wheelsize", "m", 1000, 0, 0, 8, 132 },
   { 0, "auto_wheelsize", "m", 1000, 0, 0, 9, 132 },
   { 0, "bike_weight", "kg", 10, 0, 0, 10, 132 },
   { 0, "power_cal_factor", "%", 10, 0, 0, 11, 132 },
   { 0, "auto_wheel_cal", "", 1, 0, 0, 12, 0 },
   { 0, "auto_power_zero", "", 1, 0, 0, 13, 0 },
   { 0, "id", "", 1, 0, 0, 14, 2 },
   { 0, "spd_enabled", "", 1, 0, 0, 15, 0 },
   { 0, "cad_enabled", "", 1, 0, 0, 16, 0 },
   { 0, "spdcad_enabled", "", 1, 0, 0, 17, 0 },
   { 0, "power_enabled", "", 1, 0, 0, 18, 0 },
};
...
static const Profile::FIELD sessionFields[] =
{
   ...
   { 0, "total_training_effect", "", 10, 0, 0, 24, 2 },
...
static const Profile::FIELD courseFields[] =
{
   { 0, "sport", "", 1, 0, 0, 4, 0 },
   { 0, "name", "", 1, 0, 0, 5, 7 },
   { 0, "capabilities", "", 1, 0, 0, 6, 140 },
};

static const Profile::FIELD coursePointFields[] =
{
   { 0, "message_index", "", 1, 0, 0, 254, 132 },
   { 0, "timestamp", "", 1, 0, 0, 1, 134 },
   { 0, "position_lat", "semicircles", 1, 0, 0, 2, 133 },
   { 0, "position_long", "semicircles", 1, 0, 0, 3, 133 },
   { 0, "distance", "m", 100, 0, 0, 4, 134 },
   { 0, "type", "", 1, 0, 0, 5, 0 },
   { 0, "name", "", 1, 0, 0, 6, 7 },
};
...
const Profile::MESG Profile::mesgs[MESGS] =
{
   ...
   { sdmProfileFields, "sdm_profile", FIT_MESG_NUM_SDM_PROFILE, 6 },
   { bikeProfileFields, "bike_profile", FIT_MESG_NUM_BIKE_PROFILE, 20 },
   ...
   { totalsFields, "totals", FIT_MESG_NUM_TOTALS, 7 },
