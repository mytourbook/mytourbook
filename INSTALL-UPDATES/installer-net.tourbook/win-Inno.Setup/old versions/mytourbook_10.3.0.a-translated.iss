[Setup]
AppName=MyTourbook
AppVerName=MyTourbook 10.3.0
AppCopyright=MyTourbook Contributors 2005, 2010
AppID={{37852811-BC7D-411C-8122-E69CCA892582}

LicenseFile=M:\mytourbook-TRUNK\net.tourbook\gpl.txt

OutputDir=M:\mytourbook-PRODUCT\10.3.0-translated
OutputBaseFilename=mytourbook_10.3.0.win32.win32.x86.setup

DefaultGroupName=MyTourbook
DefaultDirName={pf}\MyTourbook

VersionInfoVersion=10.3.0
...
[Files]
Source: M:\mytourbook-PRODUCT\10.3.0-translated\mytourbook_10.3.0.win32.win32.x86\mytourbook\*; DestDir: {app}; Flags: recursesubdirs; Tasks: ; Languages:
