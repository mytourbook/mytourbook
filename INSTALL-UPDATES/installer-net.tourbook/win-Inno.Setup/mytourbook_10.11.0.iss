...
OutputDir=M:\mytourbook-PRODUCT\10.11.0
OutputBaseFilename=mytourbook_10.11.0.win32.win32.x86.setup

DefaultGroupName=MyTourbook
DefaultDirName={pf}\MyTourbook

VersionInfoVersion=10.11.0
...
[Files]
Source: M:\MyTourbook-Product\10.11.0\mytourbook_10.11.0.win32.win32.x86\mytourbook\*; DestDir: {app}; Flags: recursesubdirs; Tasks: ; Languages:
