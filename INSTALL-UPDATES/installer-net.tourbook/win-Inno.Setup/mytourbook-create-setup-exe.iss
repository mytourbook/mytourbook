...
OutputBaseFilename   = mytourbook-{#AppVersion}{#AppSubVersion}-win.x86-setup
...
[Files]
Source: {#ProductRoot}{#AppVersion}\mytourbook-{#AppVersion}{#AppSubVersion}-win.x86\mytourbook\*; DestDir: {app}; Flags: recursesubdirs; Tasks: ; Languages:
