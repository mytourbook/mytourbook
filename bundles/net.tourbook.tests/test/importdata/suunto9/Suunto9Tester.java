...
class Suunto9Tester {
   ...
   void testImportSplitFiles() {
      ...
      // ORDER 1 - 2 - 3
		...
		deviceDataReader.processDeviceData(maxWell1FilePath, deviceData, alreadyImportedTours, newlyImportedTours, new ImportStates());
		deviceDataReader.processDeviceData(maxWell2FilePath, deviceData, alreadyImportedTours, newlyImportedTours, new ImportStates());
		deviceDataReader.processDeviceData(maxWell3FilePath, deviceData, alreadyImportedTours, newlyImportedTours, new ImportStates());
