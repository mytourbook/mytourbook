 ...
 *******************************************************************************/
package device.hac4linux.tour;

import net.tourbook.device.hac4linux.tour.HAC4LinuxDeviceReader;
...
public class HAC4LinuxDeviceReaderTests extends DeviceDataReaderTester {

   public static final String    FILES_PATH       = FilesUtils.rootPath + "device/hac4linux/tour/files/"; //$NON-NLS-1$
