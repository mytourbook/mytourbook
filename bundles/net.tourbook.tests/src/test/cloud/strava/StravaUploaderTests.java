...
public class StravaUploaderTests {
   ...
   void testManualTourUpload() {
      ...
      httpClientMock
            ...
            .withBody(equalTo(
                  "{\"distance\":10,\"trainer\":\"0\",\"start_date_local\":\"2022-01-03T17:16:00Z[UTC]\",\"name\":\"Manual Tour ⛅\",\"elapsed_time\":3600,\"description\":\"⛅ Partly cloudy, -1°C, feels like -6°C, 18km/h from W, air quality Very poor, 78% humidity, precipitation 3.0mm, snowfall 1.3mm\",\"type\":\"Run\"}")) //$NON-NLS-1$
            .called();
