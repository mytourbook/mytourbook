...
public class WeatherAPIRetrieverTests {
   ...
   void testWeatherRetrieval() throws IllegalAccessException, NoSuchFieldException {
      ...
      final String openWeatherMapResponse1 = Comparison.readFileContent(WEATHERAPI_FILE_PATH
      ...
      final String openWeatherMapResponse2 = Comparison.readFileContent(WEATHERAPI_FILE_PATH
