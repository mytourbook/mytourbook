...
//		group.setBackground(Display.getCurrent().getSystemColor(SWT.COLOR_GREEN));
	...
	public void resetToDefaults() {
		...
		_chkShowNumberOfTours.setSelection(//
				_prefStore.getDefaultBoolean(ITourbookPreferences.STAT_MONTH_IS_SHOW_NUMBER_OF_TOURS));
	...
	public void restoreState() {
		...
		_chkShowNumberOfTours.setSelection(//
				_prefStore.getBoolean(ITourbookPreferences.STAT_MONTH_IS_SHOW_NUMBER_OF_TOURS));
	...
	public void saveState() {
		...
		_prefStore.setValue(//
				ITourbookPreferences.STAT_MONTH_IS_SHOW_NUMBER_OF_TOURS,
		...
		_prefStore.setValue(
				ITourbookPreferences.STAT_MONTH_CHART_TYPE,
