...
public class ActionDeleteVertex extends Action {
	...
	public ActionDeleteVertex(final DialogMap3ColorEditor dialogMap3ColorEditor) {
		...
		setImageDescriptor(TourbookPlugin.getImageDescriptor(net.tourbook.Messages.Image__App_Trash));
		setDisabledImageDescriptor(TourbookPlugin.getImageDescriptor(net.tourbook.Messages.Image__App_Trash_Disabled));
	}
