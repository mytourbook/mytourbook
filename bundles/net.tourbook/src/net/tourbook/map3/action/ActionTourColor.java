...
public class ActionTourColor extends ContributionItem implements IOpeningDialog {
   ...
   public static ActionTourColor createAction(final MapGraphId colorId, final Map3View map3View, final Composite parent) {
      ...
      switch (colorId) {
      case Altitude:
         return new ActionTourColor(MapGraphId.Altitude,
               true,
               map3View,
               parent,
      ...
      case Gradient:
         return new ActionTourColor(MapGraphId.Gradient,
               true,
               map3View,
               parent,
      ...
      case Pace:
         return new ActionTourColor(MapGraphId.Pace,
               true,
               map3View,
               parent,
      ...
      case Speed:
         return new ActionTourColor(MapGraphId.Speed,
               true,
               map3View,
               parent,
      ...
      case HrZone:
         return new ActionTourColor(MapGraphId.HrZone,
               false,
               map3View,
               parent,
   ...
   public void fill(final ToolBar toolbar, final int index) {
      ...
      if (_actionColor == null && toolbar != null) {
         ...
         _actionColor.setDisabledImage(net.tourbook.ui.UI.getGraphImage_Disabled(_graphId));
