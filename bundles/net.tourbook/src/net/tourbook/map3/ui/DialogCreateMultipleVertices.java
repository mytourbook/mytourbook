...
public class DialogCreateMultipleVertices extends Dialog {
   ...
   {
      _defaultSelectionListener = widgetSelectedAdapter(selectionEvent -> validateFields());
      ...
      {
         {
            ...
            _spinStartValue.addSelectionListener(_defaultSelectionListener);
...

         {
            ...
            _spinEndValue.addSelectionListener(_defaultSelectionListener);
...

         {
            ...
            _spinValueDiff.addSelectionListener(_defaultSelectionListener);
