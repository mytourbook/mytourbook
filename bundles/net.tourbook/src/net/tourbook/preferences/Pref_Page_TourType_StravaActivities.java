...
public class Pref_Page_TourType_StravaActivities extends PreferencePage implements IWorkbenchPreferencePage {
   ...
   public Pref_Page_TourType_StravaActivities() {}

   public Pref_Page_TourType_StravaActivities(final String title) {
      super(title);
   }

   public Pref_Page_TourType_StravaActivities(final String title, final ImageDescriptor image) {
      super(title, image);
   }
