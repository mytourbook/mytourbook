...
public interface ITourbookPreferences {
    ...
    * Training Stress
    */
   public static final String TRAININGSTRESS_GOVSS_THRESHOLD_POWER_DURATION_HOURS   = "TRAININGSTRESS_GOVSS_THRESHOLD_POWER_DURATION_HOURS";   //$NON-NLS-1$
   public static final String TRAININGSTRESS_GOVSS_THRESHOLD_POWER_DURATION_MINUTES = "TRAININGSTRESS_GOVSS_THRESHOLD_POWER_DURATION_MINUTES"; //$NON-NLS-1$
   public static final String TRAININGSTRESS_GOVSS_THRESHOLD_POWER_DURATION_SECONDS = "TRAININGSTRESS_GOVSS_THRESHOLD_POWER_DURATION_SECONDS"; //$NON-NLS-1$
   public static final String TRAININGSTRESS_GOVSS_THRESHOLD_POWER_DISTANCE         = "TRAININGSTRESS_GOVSS_THRESHOLD_POWER_DISTANCE";         //$NON-NLS-1$
   public static final String TRAININGSTRESS_GOVSS_THRESHOLD_POWER_AVERAGE_SLOPE    = "TRAININGSTRESS_GOVSS_THRESHOLD_POWER_AVERAGE_SLOPE";    //$NON-NLS-1$
