...
public interface ITourbookPreferences {
	...
	public static final String	GRAPH_USE_GRAPH_BG_STYLE_HR_ZONE					= "GRAPH_USE_GRAPH_BG_STYLE_HR_ZONE";				//$NON-NLS-1$
	public static final String	GRAPH_USE_GRAPH_BG_STYLE_SWIM_STYLE				= "GRAPH_USE_GRAPH_BG_STYLE_SWIM_STYLE";			//$NON-NLS-1$
