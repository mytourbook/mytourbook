...
public interface ITourbookPreferences {
   ...
   public static final String GRAPH_MARKER_IS_LABEL_ELEVATION                              = "GRAPH_MARKER_IS_MODIFIED";                               //$NON-NLS-1$
   public static final String GRAPH_MARKER_IS_LABEL_DISTANCE                               = "GRAPH_MARKER_IS_MODIFIED";                               //$NON-NLS-1$
   public static final String GRAPH_MARKER_IS_LABEL_TIME                                   = "GRAPH_MARKER_IS_MODIFIED";                               //$NON-NLS-1$
   public static final String GRAPH_MARKER_IS_LABEL_TIME_DIFFERENCE                        = "GRAPH_MARKER_IS_MODIFIED";                               //$NON-NLS-1$
   public static final String GRAPH_MARKER_IS_LABEL_DISTANCE_DIFFERENCE                    = "GRAPH_MARKER_IS_MODIFIED";                               //$NON-NLS-1$
   public static final String GRAPH_MARKER_IS_LABEL_ELEVATIONGAIN_DIFFERENCE               = "GRAPH_MARKER_IS_MODIFIED";                               //$NON-NLS-1$
   ...
   public static final String GRAPH_MARKER_IS_SHOW_MARKER_TOOLTIP_ELEVATION                = "GRAPH_MARKER_IS_SHOW_MARKER_TOOLTIP_ELEVATION";          //$NON-NLS-1$
   public static final String GRAPH_MARKER_IS_SHOW_MARKER_TOOLTIP_DISTANCE                 = "GRAPH_MARKER_IS_SHOW_MARKER_TOOLTIP_DISTANCE";           //$NON-NLS-1$
   public static final String GRAPH_MARKER_IS_SHOW_MARKER_TOOLTIP_DURATION                 = "GRAPH_MARKER_IS_SHOW_MARKER_TOOLTIP_DURATION";           //$NON-NLS-1$
   public static final String GRAPH_MARKER_IS_SHOW_MARKER_TOOLTIP_ELEVATIONGAIN_DIFFERENCE = "GRAPH_MARKER_IS_SHOW_MARKER_TOOLTIP_ELEVATIONGAIN_DIFFERENCE"; //$NON-NLS-1$
   public static final String GRAPH_MARKER_IS_SHOW_MARKER_TOOLTIP_DISTANCE_DIFFERENCE      = "GRAPH_MARKER_IS_SHOW_MARKER_TOOLTIP_DISTANCE_DIFFERENCE"; //$NON-NLS-1$
   public static final String GRAPH_MARKER_IS_SHOW_MARKER_TOOLTIP_DURATION_DIFFERENCE      = "GRAPH_MARKER_IS_SHOW_MARKER_TOOLTIP_DURATION_DIFFERENCE"; //$NON-NLS-1$
