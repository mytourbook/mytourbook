...
public class DialogSetTimeZone extends WizardDialog {
   ...
   public static final int        TIME_ZONE_ACTION_ADJUST_TOUR_START_YYMMDD = 20;

   private static IDialogSettings _state                                    = TourbookPlugin.getState("net.tourbook.tour.DialogSetTimeZone"); //$NON-NLS-1$
