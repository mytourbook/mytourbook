...
public class ActionFilterTourWithPhotos extends Action {
   ...
   public ActionFilterTourWithPhotos(final TourPhotoLinkView photosAndToursView) {
      ...
      setImageDescriptor(TourbookPlugin.getImageDescriptor(Images.Image__Photo_FilterTourWithPhotos));
      setDisabledImageDescriptor(TourbookPlugin.getImageDescriptor(Images.Image__Photo_FilterTourWithPhotos_Disabled));
   }
