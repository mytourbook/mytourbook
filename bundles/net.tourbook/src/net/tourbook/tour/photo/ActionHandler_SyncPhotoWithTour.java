...
public class ActionHandler_SyncPhotoWithTour extends AbstractHandler implements IElementUpdater {
...
//            picDirView.fireCurrentSelection();
   ...
   public void setEnabled(final Object evaluationContext) {
      ...
      if (_isInitializedState == false) {
         ...
         final Command command = wb.getService(ICommandService.class).getCommand(COMMAND_ID);
...
//      // TODO remove SYSTEM.OUT.PRINTLN
   ...
   public void updateElement(final UIElement uiElement, final Map parameters) {
      ...
      UI.setThemedIcon(uiElement, Images.PhotoSyncTour);
   }
}
