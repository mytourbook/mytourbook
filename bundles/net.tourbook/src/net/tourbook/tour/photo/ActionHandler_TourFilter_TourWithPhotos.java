...
public class ActionHandler_TourFilter_TourWithPhotos extends AbstractHandler implements IElementUpdater {
   ...
   public void setEnabled(final Object evaluationContext) {
      ...
      if (_isAppPhotoFilterInitialized == false) {
          ...
          */
         final Command command = PlatformUI
               .getWorkbench()
               .getService(ICommandService.class)
               .getCommand(ActionHandler_TourFilter_TourWithPhotos.COMMAND_ID);
   ...
   public void updateElement(final UIElement uiElement, final Map parameters) {
      ...
      uiElement.setIcon(TourbookPlugin.getImageDescriptor(
            ThemeUtil.getThemedImageName(Images.TourFilter_TourWithPhotos)));
   }
