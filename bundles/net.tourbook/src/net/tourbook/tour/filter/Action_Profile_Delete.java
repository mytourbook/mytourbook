...
public class Action_Profile_Delete extends Action {

	private SlideoutTourFilter _slideoutTourFilter;

	public Action_Profile_Delete(final SlideoutTourFilter slideoutTourFilter) {

		super(null, AS_PUSH_BUTTON);

		_slideoutTourFilter = slideoutTourFilter;

		setToolTipText(Messages.Slideout_TourFilter_Action_DeleteProfile_Tooltip);
	...
	public void run() {
		...
		_slideoutTourFilter.action_ProfileDelete();
	}
