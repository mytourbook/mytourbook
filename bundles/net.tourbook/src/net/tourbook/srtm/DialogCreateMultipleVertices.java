...
public class DialogCreateMultipleVertices extends Dialog {
   ...
   private static final String   STATE_END_ELEVATION          = "end-elevation";              //$NON-NLS-1$
   private static final String   STATE_ELEVATION_DIFF         = "elevation-difference";       //$NON-NLS-1$
   ...
   private void restoreState() {
      ...
      String endEle = fState.get(STATE_END_ELEVATION);
      if (endEle == null) {
         endEle = DEFAULT_ELEVATION_END;
      }
      fTxtEndEleValue.setText(endEle);

      String eleDiff = fState.get(STATE_ELEVATION_DIFF);
      if (eleDiff == null) {
   ...
   private void saveState() {
      ...
      fState.put(STATE_END_ELEVATION, fTxtEndEleValue.getText());
      fState.put(STATE_ELEVATION_DIFF, fTxtEleDiff.getText());
   }
