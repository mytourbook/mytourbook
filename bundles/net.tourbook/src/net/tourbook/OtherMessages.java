...
// SET_FORMATTING_OFF
   ...
   public static final String SLIDEOUT_MAP_PHOTO_OPTIONS_ACTION_DESELECT_PHOTO            = net.tourbook.Messages.Slideout_Map_PhotoOptions_Action_DeselectPhoto;
   public static final String SLIDEOUT_MAP_PHOTO_OPTIONS_ACTION_DESELECT_PHOTO_TOOLTIP    = net.tourbook.Messages.Slideout_Map_PhotoOptions_Action_DeselectPhoto_Tooltip;
   public static final String SLIDEOUT_MAP_PHOTO_OPTIONS_CHECKBOX_AUTO_SELECT             = net.tourbook.Messages.Slideout_Map_PhotoOptions_Checkbox_AutoSelect;
