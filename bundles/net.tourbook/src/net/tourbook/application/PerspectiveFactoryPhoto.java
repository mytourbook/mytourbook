...
public class PerspectiveFactoryPhoto implements IPerspectiveFactory {
   ...
   public void createInitialLayout(final IPageLayout layout) {
      ...
      layout.addShowViewShortcut(TourPhotoLinkView.ID);
      layout.addShowViewShortcut(TourPhotosView.ID);
      layout.addShowViewShortcut(PicDirView.ID);
      ...
      folderMap.addPlaceholder(IExternalIds.VIEW_ID_NET_TOURBOOK_MAP3_MAP3_VIEW_ID);
