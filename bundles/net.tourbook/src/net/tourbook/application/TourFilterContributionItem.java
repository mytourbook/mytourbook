...
public class TourFilterContributionItem extends ContributionItem implements IOpeningDialog {
	...
	public TourFilterContributionItem() {
	...
	public void fill(final ToolBar toolbar, final int index) {
		...
		if (_actionToolItem == null && toolbar != null) {
			...
			_slideoutTourFilter = new SlideoutTourFilter(toolbar, _toolBar);
	...
	private void onMouseMove(final ToolItem item, final MouseEvent mouseEvent) {
		...
		_slideoutTourFilter.open(itemBounds, true);
	}
