...
public class PrefPageProxy extends PreferencePage implements IWorkbenchPreferencePage {
   ...
   private Control createUI(final Composite parent) {
      ...
      final ModifyListener modifyListener = modifyEvent -> validateData();
...
//		container.setBackground(Display.getCurrent().getSystemColor(SWT.COLOR_RED));
      {
         ...
         _rdoNoProxy.addSelectionListener(selectionListener);
         ...
         _rdoSystemProxy.addSelectionListener(selectionListener);
         ...
         _rdoProxy.addSelectionListener(selectionListener);
         ...
         _rdoSocksProxy.addSelectionListener(selectionListener);
