...
public class TourEquipmentFilterSqlJoinBuilder {
   ...
   public TourEquipmentFilterSqlJoinBuilder() {

      setupBuilder(false);
   }

   public TourEquipmentFilterSqlJoinBuilder(final boolean isDistinctTourId) {
