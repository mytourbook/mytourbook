...
public class TVIEquipCategory extends TVIEquipmentItem {
   ...
   public TVIEquipCategory(final TreeViewer tagViewer, final TourTagCategory tourTagCategory) {
   ...
   protected void fetchChildren() {
      ...
      for (final TourTagCategory tagCategory : lazyTourTagCategories) {
         addChild(new TVIEquipCategory(tagViewer, tagCategory));
      }
      ...
      tree.getDisplay().asyncExec(() -> {
         ...
         tagViewer.update(TVIEquipCategory.this, null);
      });
   }
