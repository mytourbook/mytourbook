...
public class TVIEquipmentView_Part_Month extends TVIEquipmentView_Item {
   ...
   /**
    * Compare two instances of {@link TVIEquipmentView_Part_Month}
    *
    * @param otherMonthItem
    *
    * @return
    */
   public int compareTo(final TVIEquipmentView_Part_Month otherMonthItem) {
   ...
   public boolean equals(final Object obj) {
      ...
      final TVIEquipmentView_Part_Month other = (TVIEquipmentView_Part_Month) obj;
   ...
   private void loadChildren_Tours() {
      ...
      try (Connection conn = TourDatabase.getInstance().getConnection()) {
         ...
         // parameter: next
         statement.setLong(nextIndex, _yearItem.getPartId());
