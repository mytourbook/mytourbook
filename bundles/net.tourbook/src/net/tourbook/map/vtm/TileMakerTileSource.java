...
public class TileMakerTileSource extends UrlTileSource {
...
//	http://192.168.99.99:8080/all/16/19293/24641.mvt
	...
	public static class Builder<T extends Builder<T>> extends UrlTileSource.Builder<T> {
		...
		@Override
		public TileMakerTileSource build() {
			return new TileMakerTileSource(this);
		}
	}

	public TileMakerTileSource() {

		this(builder());
	}

	protected TileMakerTileSource(final Builder<?> builder) {

		super(builder);
	}

	public TileMakerTileSource(final String urlString) {
