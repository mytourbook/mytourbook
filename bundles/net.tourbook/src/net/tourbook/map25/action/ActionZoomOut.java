...
public class ActionZoomOut extends Action {
	...
	public ActionZoomOut(final Map25View map25View) {
      ...
      setImageDescriptor(TourbookPlugin.getImageDescriptor(Images.image_action_zoom_out));
      setDisabledImageDescriptor(TourbookPlugin.getImageDescriptor(Images.image_action_zoom_out_disabled));
	}
