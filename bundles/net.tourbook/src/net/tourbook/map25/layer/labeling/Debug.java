...
/**
 * Original: {@link org.oscim.layers.tile.vector.labeling.Debug}
 */
class Debug {
    ...
    static void addDebugBox(final Label l, final TextItem ti, int overlaps, final boolean prev,
                            final float scale) {
        ...
        final float[] points = mDebugPoints;
        final float width = (ti.x2 - ti.x1) / 2f;
        final float height = (ti.y2 - ti.y1) / 2f;
