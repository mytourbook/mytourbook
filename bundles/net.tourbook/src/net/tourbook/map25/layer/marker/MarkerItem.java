...
public class MarkerItem implements MarkerInterface {
	...
	/**
	 * If a MarkerItem is created using this convenience class instead of MarkerItem, this specific
	 * item will not be clusterable.
	 */
	...
	public MarkerItem(final Object uid, final String title, final String description, final GeoPoint geoPoint) {
	 ...
	 */
	public MarkerItem(final String title, final String description, final GeoPoint geoPoint) {
