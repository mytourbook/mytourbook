...
public class TourTypeFilterSet {
    ...
    * <p>
    * It is initialized with an empty array to prevent 10+ year old NPE's in different locations,
    * which were not yet detected until now.
    */
   private Object[] _tourTypes = new Object[] {};
