...
public class TourNutritionView extends ViewPart {

   //TODO FB put everything in this view so that it doesn't bloat the tour data editor views
...
//
//         return new SlideoutTourBlogOptions(_parent, toolbar, TourNutritionView.this, _state);
//      }
//   }
   ...
   private void addSelectionListener() {
      ...
      _postSelectionListener = new ISelectionListener() {
         ...
         public void selectionChanged(final IWorkbenchPart part, final ISelection selection) {
            if (part == TourNutritionView.this) {
               return;
            }
