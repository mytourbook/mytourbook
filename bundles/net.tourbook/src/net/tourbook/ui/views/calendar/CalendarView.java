...
public class CalendarView extends ViewPart implements ITourProvider, ICalendarProfileListener {
   ...
   private void createActions() {
       ...
       */
      {
         ...
         _actionBack.setImageDescriptor(TourbookPlugin.getImageDescriptor(Images.Image__ArrowUp));
      }
       ...
       */
      {
         ...
         _actionForward.setImageDescriptor(TourbookPlugin.getImageDescriptor(Images.Image__ArrowDown));
      }
       ...
       */
      {
         ...
         _actionSetLinked.setImageDescriptor(TourbookPlugin.getImageDescriptor(Images.Image__SyncViews));
       ...
       */
      {
         ...
         _actionGotoToday.setImageDescriptor(TourbookPlugin.getImageDescriptor(Images.Image__Today));
      }
   }
