...
abstract class NumberDataFormatter extends DataFormatter {

   NumberDataFormatter(final FormatterID id) {
      super(id);
   }

   NumberDataFormatter(final FormatterID id, final String name, final String colorName) {
