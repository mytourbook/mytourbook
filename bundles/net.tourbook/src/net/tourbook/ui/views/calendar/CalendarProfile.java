...
// SET_FORMATTING_OFF
        ...
        sb.append("\n");                                                                                            //$NON-NLS-1$
        sb.append("\n");                                                                                            //$NON-NLS-1$
        sb.append("profile.allTourFormatterData          = " + dump_Formatter(allTourFormatterData)); //$NON-NLS-1$
        sb.append("\n");                                                                                            //$NON-NLS-1$
        sb.append("profile.allWeekFormatterData          = " + dump_Formatter(allWeekFormatterData)); //$NON-NLS-1$
        sb.append("\n");                                                                                            //$NON-NLS-1$
...
// SET_FORMATTING_ON
   ...
   private String dump_Formatter(final FormatterData[] allFormatterData) {
      ...
      for (final FormatterData formatterData : allFormatterData) {
         ...
         case ELEVATION:
            formatterID = FormatterID.ELEVATION.name();
            break;
