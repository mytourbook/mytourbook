...
// SET_FORMATTING_ON
   ...
   private ChartDataModel createChartDataModel(final List<TourData> hrvTours) {
      ...
      yDataRR1.setRgbTourType_Gradient_Dark(allRgbDark);
      yDataRR1.setRgbTourType_Gradient_Bright(allRgbGradient_Bright);
      yDataRR1.setRgbTourType_Line(allRgbLine);
      yDataRR1.setRgbTourType_Text(new RGB[] { rgbTextColor });
