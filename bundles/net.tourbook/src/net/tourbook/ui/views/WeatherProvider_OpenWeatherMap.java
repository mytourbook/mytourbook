...
public class WeatherProvider_OpenWeatherMap implements IWeatherProvider {
   ...
   public Composite createUI(final WeatherProvidersUI weatherProvidersUI,
      ...
      _weatherProvidersUI = weatherProvidersUI;
      _tk = tk;
...
//		container.setBackground(Display.getCurrent().getSystemColor(SWT.COLOR_YELLOW));
      {
         ...
         btnComputValues.addSelectionListener(widgetSelectedAdapter(selectionEvent -> _weatherProvidersUI.computeSmoothingForAllTours()));
