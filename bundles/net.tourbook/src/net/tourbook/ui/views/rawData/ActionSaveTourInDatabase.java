...
public class ActionSaveTourInDatabase extends Action {
   ...
   public ActionSaveTourInDatabase(final RawDataView viewPart, final boolean isWithPerson) {
      ...
      setImageDescriptor(isWithPerson
            ...
            : TourbookPlugin.getThemedImageDescriptor(Images.Saved_Tour_OtherPerson));

      setDisabledImageDescriptor(TourbookPlugin.getThemedImageDescriptor(Images.Saved_Tour_Disabled));
      ...
      try {
         ...
         for (final TourPerson person : _people) {
            if (person.getPersonId() == personId) {
               dialog.setInitialSelections(new Object[] { person });
               break;
            }
         }
