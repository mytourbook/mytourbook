...
public class ActionHandler_OpenView_TourMarkerAll extends AbstractHandler implements IElementUpdater {
   ...
   public void updateElement(final UIElement uiElement, final Map parameters) {
      ...
      uiElement.setIcon(TourbookPlugin.getImageDescriptor(
            ThemeUtil.getThemedImageName(Images.TourMarker_All)));
   }
}
