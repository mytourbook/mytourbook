...
class ActionDeleteTimeSlices_RemoveTime extends Action {

   private final TourDataEditorView _tourDataEditorView;

   public ActionDeleteTimeSlices_RemoveTime(final TourDataEditorView tourDataEditorView) {
   ...
   @Override
   public void run() {
      _tourDataEditorView.actionDelete_TimeSlices(true, true, false);
   }
}
