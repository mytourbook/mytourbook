...
public class TVIRefTour_RefTourItem extends TVIRefTour_TourItem {
   ...
   public boolean equals(final Object obj) {
      ...
      if (!(obj instanceof TVIRefTour_RefTourItem)) {
         return false;
      }
      final TVIRefTour_RefTourItem other = (TVIRefTour_RefTourItem) obj;
   ...
   protected void fetchChildren() {
      ...
      if (_viewLayout == ElevationCompareManager.REF_TOUR_VIEW_LAYOUT_WITHOUT_YEAR_CATEGORIES) {
...
// SET_FORMATTING_ON
            ...
            if (tourId == lastTourId) {
               ...
               final TVIRefTour_ComparedTour tourItem = new TVIRefTour_ComparedTour(parentItem);
...
// SET_FORMATTING_OFF
                ...
                * From TourData
                */
               tourItem.hasGeoData                 = result.getBoolean(12);
               tourItem.tourTitle                  = result.getString(13);
               final Object tourTypeId             = result.getObject(14);
   ...
   private void fetchChildren_WithYearCategories(final ArrayList<TreeViewerItem> children) {
      ...
      try (Connection conn = TourDatabase.getInstance().getConnection()) {
         ...
         while (result.next()) {
            ...
            final TVIRefTour_YearItem yearItem = new TVIRefTour_YearItem(this);
