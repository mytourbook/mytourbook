...
public class ActionSetHRZones_SelectedTours extends Action implements ITourDataUpdate_OnlyUpdate {

   private final ITourProviderByID _tourProvider;

   public ActionSetHRZones_SelectedTours(final ITourProviderByID tourProvider) {

      super(null, AS_PUSH_BUTTON);

      _tourProvider = tourProvider;

      setText(Messages.Tour_Action_HRZones_InSelectedTours);
      setToolTipText(Messages.Tour_Action_HRZones_InSelectedTours_Tooltip);
   }
