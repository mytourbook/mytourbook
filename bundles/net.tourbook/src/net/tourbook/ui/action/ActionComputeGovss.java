...
public class ActionComputeGovss extends Action {

   private final ITourProvider     _tourProvider;

   public ActionComputeGovss(final ITourProvider tourDataEditor) {
   ...
   public void run() {
      ...
      try {
         ...
         isTaskDone = TourManager.computeGovss(sqlConnection, selectedTours);
