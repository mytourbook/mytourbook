...
public abstract class TreeColumnFactory {
	...
	public static final TreeColumnFactory	DEVICE_IMPORT_FILE_NAME;
	public static final TreeColumnFactory	DEVICE_IMPORT_FILE_PATH;
	public static final TreeColumnFactory	DEVICE_TIME_INTERVAL;
	...
	public static final TreeColumnFactory	TOUR_SPEED_AVG;
	public static final TreeColumnFactory	TOUR_DISTANCE;
	public static final TreeColumnFactory	TOUR_DP_TOLERANCE;
	public static final TreeColumnFactory	TOUR_ALTITUDE_DOWN;
	public static final TreeColumnFactory	TOUR_ALTITUDE_UP;
	public static final TreeColumnFactory	TOUR_AVG_PACE;
	public static final TreeColumnFactory	TOUR_TIME_SLICES;
	...
	public static final TreeColumnFactory	TOUR_MAX_ALTITUDE;
	public static final TreeColumnFactory	TOUR_SPEED_MAX;
	...
	static {
		...
		TOUR_ALTITUDE_DOWN = new TreeColumnFactory() {
			@Override
		...
		TOUR_ALTITUDE_UP = new TreeColumnFactory() {
			@Override
			public TreeColumnDefinition createColumn(	final ColumnManager columnManager,
														final PixelConverter pixelConverter) {
		...
		TOUR_AVG_PACE = new TreeColumnFactory() {
			@Override
			public TreeColumnDefinition createColumn(	final ColumnManager columnManager,
														final PixelConverter pixelConverter) {
		...
		TOUR_SPEED_AVG = new TreeColumnFactory() {
			@Override
			public TreeColumnDefinition createColumn(	final ColumnManager columnManager,
														final PixelConverter pixelConverter) {
		...
		TOUR_DISTANCE = new TreeColumnFactory() {
			@Override
			public TreeColumnDefinition createColumn(	final ColumnManager columnManager,
														final PixelConverter pixelConverter) {
		...
		TOUR_DP_TOLERANCE = new TreeColumnFactory() {
			@Override
			public TreeColumnDefinition createColumn(	final ColumnManager columnManager,
														final PixelConverter pixelConverter) {
		...
		DEVICE_IMPORT_FILE_NAME = new TreeColumnFactory() {
			@Override
			public TreeColumnDefinition createColumn(	final ColumnManager columnManager,
														final PixelConverter pixelConverter) {
		...
		DEVICE_IMPORT_FILE_PATH = new TreeColumnFactory() {
			@Override
			public TreeColumnDefinition createColumn(	final ColumnManager columnManager,
														final PixelConverter pixelConverter) {
		...
		TOUR_MAX_ALTITUDE = new TreeColumnFactory() {
			@Override
			public TreeColumnDefinition createColumn(	final ColumnManager columnManager,
														final PixelConverter pixelConverter) {
		...
		TOUR_SPEED_MAX = new TreeColumnFactory() {
		...
		DEVICE_TIME_INTERVAL = new TreeColumnFactory() {
			@Override
			public TreeColumnDefinition createColumn(	final ColumnManager columnManager,
														final PixelConverter pixelConverter) {
		...
		TOUR_TIME_SLICES = new TreeColumnFactory() {
			@Override
			public TreeColumnDefinition createColumn(	final ColumnManager columnManager,
														final PixelConverter pixelConverter) {
