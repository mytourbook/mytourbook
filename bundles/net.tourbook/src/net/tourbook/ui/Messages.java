...
public class Messages extends NLS {
   ...
   public static String        ColumnFactory_RunDyn_StanceTime_Max_Header;
   public static String        ColumnFactory_RunDyn_StanceTime_Min;
   public static String        ColumnFactory_RunDyn_StanceTime_Min_Header;
   public static String        ColumnFactory_RunDyn_StanceTimeBalance_Avg;
   public static String        ColumnFactory_RunDyn_StanceTimeBalance_Avg_Header;
   public static String        ColumnFactory_RunDyn_StanceTimeBalance_Max;
   ...
   public static String        ColumnFactory_TimeZoneDifference_Header;
   public static String        ColumnFactory_TimeZoneDifference_Label;
