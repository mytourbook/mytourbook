...
public class ChartLayerSegmentAltitude implements IChartLayer, IChartOverlay {
   ...
   private static final RGB            FLAT_GAIN_LOSS_BRIGHT_RGB = new RGB(0xFF, 0xEB, 0x5B);
   ...
   public void draw(final GC gc,
      ...
      for (int segmentIndex = 0; segmentIndex < numSegments; segmentIndex++) {
         ...
         // optimize performance, skip invisible segments
         ...
         if (segmentGradient > 0 && segmentGradient < segmentSerie_FlatGainLoss_Gradient) {
...
//                     gc.drawRectangle(validRect);
   ...
   private SegmenterSegment getHoveredSegment_10(final int devXMouse, final int devYMouse) {
      ...
      for (final SegmenterSegment paintedSegment : _paintedSegments) {
         ...
         (paintedSegment.isValueVisible
               && hoveredLabelRect != null
               && hoveredLabelRect.contains(devXMouse, devYMouse))
