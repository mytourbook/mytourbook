...
//			container.setBackground(Display.getCurrent().getSystemColor(SWT.COLOR_BLUE));
	...
	private void createUI_20_Controls(final Composite parent) {
		...
		GridLayoutFactory.fillDefaults().numColumns(2).applyTo(container);
		{
         ...
         //TODO FB Add new option "Select all time slices in between left and right slider"
         // in the tooltip, explain that otherwise it selects only the two time slices associated to the 
