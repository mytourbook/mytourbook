...
//			container.setBackground(Display.getCurrent().getSystemColor(SWT.COLOR_BLUE));
	...
	private void createUI_10_Title(final Composite parent) {
		...
		label.setText(Messages.Slideout_Map2TourColors_Label_Title);
...
//		container.setBackground(Display.getCurrent().getSystemColor(SWT.COLOR_BLUE));
	...
	private Button createUI_GraphCheckbox(final Composite parent) {
		...
		checkbox.setToolTipText(Messages.Slideout_Map2TourColors_Checkbox_ShowInChartToolbar_Tooltip);
