...
public class HoveredTour_ToolTip extends ToolTip implements ITourProvider, ITourToolTipProvider {
   ...
   public HoveredTour_ToolTip(final Map map) {

      super(map, NO_RECREATE, false);
...
//      final HoveredTour hoveredTour = _map.getHoveredTours();
//
...
//      }
      ...
      return _ttControl.toDisplay(event.x + 0, event.y + 5);
...
//      return super.getLocation(tipSize, event);
   ...
   protected Object getToolTipArea(final Event event) {
      ...
      _hoveredTour = _map.getHoveredTours();
...
//      if (_map.isShowTourTooltip() == false) {
//         return false;
//      }
      ...
      if (_hoveredTour == null || _hoveredTour.hoveredTours != null && _hoveredTour.hoveredTours.size() == 0) {
         return false;
      }

      // get tour id from hovered item
      _tourId = _hoveredTour.hoveredTours.get(0);
