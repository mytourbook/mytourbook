...
public class ActionZoomLevelAdjustment extends Action implements IMenuCreator {
   ...
   private class ActionZoomLevel extends Action {
      ...
      public void run() {
         ...
         TourPainterConfiguration.setZoomLevelAdjustment(_actionZoomLevel);
      }
   }

   public ActionZoomLevelAdjustment() {
   ...
   public void setZoomLevel(final int zoomLevel) {
      ...
      TourPainterConfiguration.setZoomLevelAdjustment(zoomLevel);
