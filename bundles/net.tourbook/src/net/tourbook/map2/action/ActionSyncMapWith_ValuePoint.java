...
public class ActionSyncMapWith_ValuePoint extends Action {
   ...
   public ActionSyncMapWith_ValuePoint(final Map2View map2View) {
      ...
      setImageDescriptor(TourbookPlugin.getImageDescriptor(Images.Image_Action_SyncWith_ValuePoint));
      setDisabledImageDescriptor(TourbookPlugin.getImageDescriptor(Images.Image_Action_SyncWith_ValuePoint_Disabled));
   }
