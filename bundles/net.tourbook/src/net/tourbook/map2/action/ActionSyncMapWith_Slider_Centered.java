...
public class ActionSyncMapWith_Slider_Centered extends Action {
   ...
   public ActionSyncMapWith_Slider_Centered(final Map2View map2View) {
      ...
      setImageDescriptor(TourbookPlugin.getImageDescriptor(Images.Image_Action_SyncWith_Slider_Centered));
      setDisabledImageDescriptor(TourbookPlugin.getImageDescriptor(Images.Image_Action_SyncWith_Slider_Centered_Disabled));
   }
