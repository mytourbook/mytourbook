...
public class MPProfile extends MP implements ITileChildrenCreator {
   ...
   public Object clone() throws CloneNotSupportedException {
      ...
      final ArrayList<MPWrapper> clonedMpWrapperList = new ArrayList<>();
   ...
   public ArrayList<Tile> createTileChildren(final Tile parentTile) {
      ...
      final ArrayList<Tile> tileChildren = new ArrayList<>();
   ...
   public void synchronizeMPWrapper() {
      ...
      if (_mpWrappers == null) {
         ...
         final ArrayList<MPWrapper> remainingMpWrappers = new ArrayList<>(_mpWrappers);
