...
public class ActionZoomIn extends Action {
	...
	public ActionZoomIn(final IMapDefaultActions mapActionProvider) {
		...
		setImageDescriptor(TourbookPlugin.getImageDescriptor(Messages.Image_Action_ZoomIn));
		setDisabledImageDescriptor(TourbookPlugin.getImageDescriptor(Messages.Image_Action_ZoomIn_Disabled));
	}
