...
public class DialogMPProfile extends DialogMP implements ITileListener, IMapDefaultActions {
   ...
   private final FormToolkit          _formTk = new FormToolkit(Display.getCurrent());
   ...
   public DialogMPProfile(final Shell parentShell,
      ...
      _dialogSettings = TourbookPlugin.getDefault().getDialogSettingsSection("DialogMapProfileConfiguration");//$NON-NLS-1$
      ...
      _mpDefault = MapProviderManager.getDefaultMapProvider();
   }
   ...
   private void createResources() {
      ...
      _imagePlaceholder = TourbookPlugin.getImageDescriptor(Images.App_IconPlaceholder).createImage();
   ...
   private void createUI_110_LeftContainer(final Composite parent) {
      ...
      GridLayoutFactory.fillDefaults().applyTo(_innerContainer);
      {
         ...
         _propContainer.addExpansionListener(expansionStateChangedAdapter(expansionEvent -> _propContainer.getParent().layout(true)));
...
//         });
   ...
   private void createUI_122_ColorSelector1(final Composite parent) {
      ...
      _transparentContainer.addExpansionListener(expansionStateChangedAdapter(expansionEvent -> {
