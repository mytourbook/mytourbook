...
public class ActionZoomOut extends Action {
	...
	public ActionZoomOut(final IMapDefaultActions mapActionProvider) {
		...
		setImageDescriptor(TourbookPlugin.getImageDescriptor(Messages.Image_Action_ZoomOut));
		setDisabledImageDescriptor(TourbookPlugin.getImageDescriptor(Messages.Image_Action_ZoomOut_Disabled));
	}
