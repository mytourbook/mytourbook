...
public class ActionRefreshOfflineInfoNotAssessed extends Action {
	...
	public ActionRefreshOfflineInfoNotAssessed(final PrefPageMapProviders prefPageMapFactories) {
		...
		setImageDescriptor(TourbookPlugin.getImageDescriptor(Messages.App_Image_RefreshNotAssessed));
		setDisabledImageDescriptor(TourbookPlugin.getImageDescriptor(Messages.App_Image_RefreshNotAssessed_Disabled));
