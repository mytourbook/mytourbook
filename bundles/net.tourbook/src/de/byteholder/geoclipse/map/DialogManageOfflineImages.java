...
public class DialogManageOfflineImages extends TitleAreaDialog implements ITileListener {
   ...
   private final IDialogSettings    _state           = TourbookPlugin.getState("DialogManageOfflineImages"); //$NON-NLS-1$
   ...
   private final ArrayList<PartMP>  _partMapProvider = new ArrayList<>();
...
//      return null;
   ...
   private void getMapProviders() {
      ...
      final ArrayList<String> storedProviderIds = Util.convertStringToList(_prefStore.getString(IMappingPreferences.MAP_PROVIDER_SORT_ORDER));

      final ArrayList<MP> mapProviders = new ArrayList<>();
      final ArrayList<String> validMpIds = new ArrayList<>();
      ...
      // save valid mp id's
      _prefStore.setValue(IMappingPreferences.MAP_PROVIDER_SORT_ORDER, Util.convertListToString(validMpIds));

      /*
       * Set state if the map provider is visible in the UI
       */
      final ArrayList<String> toggleIds = Util.convertStringToList(_prefStore.getString(IMappingPreferences.MAP_PROVIDER_VISIBLE_IN_UI));
