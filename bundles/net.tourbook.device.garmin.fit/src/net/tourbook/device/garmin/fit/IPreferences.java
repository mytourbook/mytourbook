...
public interface IPreferences {
   ...
   String FIT_IS_IMPORT_TOURTYPE_MODE           = "FIT_IS_IMPORT_TOURTYPE_MODE";          //$NON-NLS-1$

   String FIT_IS_IMPORT_TOURTYPE_MODE_SPORT           = "FIT_IS_IMPORT_TOURTYPE_MODE_SPORT";              //$NON-NLS-1$
   String FIT_IS_IMPORT_TOURTYPE_MODE_PROFILE         = "FIT_IS_IMPORT_TOURTYPE_MODE_PROFILE";            //$NON-NLS-1$
   String FIT_IS_IMPORT_TOURTYPE_MODE_TRYPROFILE      = "FIT_IS_IMPORT_TOURTYPE_MODE_TRYPROFILE";         //$NON-NLS-1$
   String FIT_IS_IMPORT_TOURTYPE_MODE_SPORTANDPROFILE = "FIT_IS_IMPORT_TOURTYPE_MODE_SPORTANDPROFILE";    //$NON-NLS-1$
}
