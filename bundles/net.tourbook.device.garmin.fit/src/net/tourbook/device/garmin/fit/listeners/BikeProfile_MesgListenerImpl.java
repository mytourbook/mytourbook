...
public class BikeProfile_MesgListenerImpl extends AbstractMesgListener implements BikeProfileMesgListener {

	public BikeProfile_MesgListenerImpl(final FitContext context) {
		super(context);
	}
