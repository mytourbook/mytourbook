...
public class StatusBar extends JPanel {
    ...
    static class StatusBarProgressHandler implements ProgressHandler {
        ...
        public StatusBarProgressHandler(final JPanel container, final String msg, final int max) {
...
//            GUIUtils.paintImmediately(container);
        ...
        @Override
        public void updateProgress(final int currentValue) {
            assert calledOnEDT() : threadInfo();
            assert determinate;
...
//        add(ZoomControl.get(), EAST);
     ...
     */
    public ProgressHandler startProgress(final String msg, final int max) {
        assert calledOnEDT() : threadInfo();
        assert msg != null;
