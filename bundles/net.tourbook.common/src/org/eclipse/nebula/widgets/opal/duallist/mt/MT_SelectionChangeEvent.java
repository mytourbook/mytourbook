 ...
 */
public class MT_SelectionChangeEvent extends TypedEvent {
    ...
    */
   public MT_SelectionChangeEvent(final Event e) {
      super(e);
   }
    ...
    */
   public List<MT_DLItem> getItems() {
      return items;
   }
