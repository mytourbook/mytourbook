...
/**
 * This interface provides access to different parts in a viewer which displays tours
 *
...
public interface ITourViewer {
   ...
   /**
    * Reloads the viewer by setting the input, this handles structural changes
    */
   void reloadViewer();

   /**
    * Updates the viewer column header, it is called when the value format of the column has
    * changed.
    *
    * @param colDef
    */
   void updateColumnHeader(ColumnDefinition colDef);
}
