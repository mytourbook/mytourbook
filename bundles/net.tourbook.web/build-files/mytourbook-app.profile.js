/**
 * Source: https://github.com/csnover/dojo-boilerplate/blob/master/profiles/app.profile.js
 * 
 * This is the default application build profile used by the boilerplate. While it looks similar, this build profile is
 * different from the package build profile at `app/package.js` in the following ways:
 * 
 ...
 * 
 * 2. the package build profile only configures the `resourceTags` for the files in the package, whereas the application
 * build profile tells the build system how to build the entire application.
 * 
...
var profile = (function() {
	...
	// ---------------------------------------------------
	var dojoSource = "C:/E/js-resources/dojo/mytourbook-dojo-toolkit";
