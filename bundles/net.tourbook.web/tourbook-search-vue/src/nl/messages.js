...
const messages = {
   ...
   en: {
      message: {
         ...
         Search_App_Tooltip                                 : '<b>Wildcard Search</b><br><br>' 
                                                               + 'A search can also be done with * or ? wildcards and other features, '
                                                               + 'read more details in the <a href="{0}" target="_blank">Lucene query parser description.</a><br><br>' 
                                                               + 'Lucene is the internal used search engine.',
         ...
         Search_Options_Checkbox_ShowDate                   : 'Show date',
         Search_Options_Checkbox_ShowDescription            : 'Show description',
         Search_Options_Checkbox_ShowItemNumber             : 'Show item number',
         Search_Options_Checkbox_ShowLuceneDocId            : 'Show Lucene doc ID',
         Search_Options_Checkbox_ShowTime                   : 'Show time',
         ...
         Search_Options_Label_SortAscending                 : 'By Date ',
   ...
   de: {
      message: {
         ...
         Search_Options_Checkbox_ShowDate                   : 'Datum anzeigen',
         Search_Options_Checkbox_ShowDescription            : 'Beschreibung anzeigen',
         ...
         Search_Options_Checkbox_ShowTime                   : 'Zeit anzeigen',
