...
const messages = {
   ...
   en: {
      message: {
         ...
         Search_App_Tooltip                                 : '<b>Wildcard Search</b><br><br>' + 'A search can also be done with * or ? wildcards and other features, read more details in the <a href=\'{0}\'>Lucene query parser description.</a><br><br>' + '' + 'Lucene is the internal used search engine.' + '',
      }
   },
