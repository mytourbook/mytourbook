...
public class HAC5DeviceData {
   ...
   private long             bike1MovingTime;
   private long             bike1Distance;
   private long             bike1AltitudeUp;
   private long             bike1AltitudeDown;

   public void readFromFile(final RandomAccessFile fileRawData) {

      final byte[] recordBuffer = new byte[0x10];
      ...
      try {
         ...
         bike1MovingTime = DeviceReaderTools.get4ByteData(recordBuffer, 0);
