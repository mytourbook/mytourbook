...
public class FitLogDeviceDataReader extends TourbookDevice {
   ...
   // File generated by the ST plugin "Copy Data" (http://www.zonefivesoftware.com/sporttracks/plugins/?p=copy-data)
   private static final String           XML_FIT_LOG_EX_TAG      = "<FitnessWorkbookEx ";                           //$NON-NLS-1$
   private static final String           XML_FIT_LOG_EX_FREE_TAG = "<FitnessWorkbookExFree ";                       //$NON-NLS-1$
