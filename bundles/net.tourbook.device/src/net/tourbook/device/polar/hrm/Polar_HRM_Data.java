...
public class Polar_HRM_Data {
   ...
   private Polar_HRM_DataReader   _polar_HRM_DataReader;
   ...
   public Polar_HRM_Data(final String importFilePath,
                         ...
                         final Polar_HRM_DataReader polar_HRM_DataReader) {
...
//		tourData.setCalories(_calories);
      ...
      tourData.setDeviceId(_polar_HRM_DataReader.deviceId);
      ...
      final String uniqueId = _polar_HRM_DataReader.createUniqueId(tourData, Util.UNIQUE_ID_SUFFIX_POLAR_HRM);
   ...
   private String getMonitorName(final int monitor) {
      ...
      return _polar_HRM_DataReader.visibleName + UI.SPACE + Messages.Import_Error_DeviceNameIsUnknown;
   }
   ...
   boolean parseSection() {
      ...
      try (FileReader fileReader = new FileReader(_importFilePath);
         ...
         createTourData(_alreadyImportedTours, _newlyImportedTours);
