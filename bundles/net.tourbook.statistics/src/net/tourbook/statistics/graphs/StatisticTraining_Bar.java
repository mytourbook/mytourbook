...
public class StatisticTraining_Bar extends StatisticTraining {
   ...
   ChartDataModel getChartDataModel() {
      ...
      if (_isShowTrainingEffect_Anaerobic) {
         createYData_TrainingEffect_Anaerobic(chartDataModel, ChartType.BAR);
      }
   ...
   private void getPreferences() {
      ...
      _isShowTrainingEffect_Anaerobic = _prefStore.getBoolean(ITourbookPreferences.STAT_TRAINING_BAR_IS_SHOW_TRAINING_EFFECT_ANAEROBIC);
