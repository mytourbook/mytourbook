...
public class DataProvider_Tour_HrZones extends DataProvider {

	private static DataProvider_Tour_HrZones	_instance;

	private ArrayList<Long>					_tourIds;

	private Long							_selectedTourId;

	private TourData_HrZone					_tourHrZoneData;

	private DataProvider_Tour_HrZones() {}

	public static DataProvider_Tour_HrZones getInstance() {
		if (_instance == null) {
			_instance = new DataProvider_Tour_HrZones();
		}
		return _instance;
	}
	 ...
	 * @return
	 */
	TourData_HrZone getTourHrZoneData(	final TourPerson person,
		...
		try {
			 ...
			 * create data
			 */
			_tourHrZoneData = new TourData_HrZone();
