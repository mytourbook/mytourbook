...
public class StatisticYear_Elevation_Up extends StatisticYear {

	@Override
	protected String getBarOrderingStateKey() {

		return STATE_BAR_ORDERING_YEAR_ELEVATION_UP;
	}
	...
	protected String getGridPrefPrefix() {
      ...
      return GRID_YEAR_ELEVATION_UP;
	}

   @Override
   protected String getLayoutPrefPrefix() {
      return LAYOUT_YEAR_ELEVATION_UP;
   }
}
