...
//      tbm.add(_actionPhotoGalleryType);
   ...
   private void updateUI_GalleryType(final GalleryType galleryType) {
      ...
      if (galleryType == GalleryType.DETAILS) {
         ...
         imageDescriptor = Activator.getImageDescriptor(Images.Image__PotoGalleryThumbnail);
         ...
         imageDescriptor = Activator.getImageDescriptor(Images.Image__PotoGalleryDetails);
      }
   ...
   private void updateUI_RatingStarBehaviour(final RatingStarBehaviour ratingStarBehaviour) {
      ...
      if (ratingStarBehaviour == RatingStarBehaviour.NO_STARS) {
         ...
         imageDescriptor = Activator.getImageDescriptor(Images.Image__PhotoRatingStarAndHovered);
         ...
         imageDescriptor = Activator.getImageDescriptor(Images.Image__PhotoRatingStar);
         ...
         imageDescriptor = Activator.getImageDescriptor(Images.Image__PhotoRatingStarHovered);
      }
