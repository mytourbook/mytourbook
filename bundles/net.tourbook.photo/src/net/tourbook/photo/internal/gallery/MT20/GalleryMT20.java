...
public abstract class GalleryMT20 extends Canvas {
   ...
   private final ListenerList<IItemListener> _itemListeners           = new ListenerList<>(ListenerList.IDENTITY);
    ...
    * they are virtual.
    */
   private HashMap<String, GalleryMT20Item>  _createdGalleryItems     = new HashMap<>();
    ...
    */
   private HashMap<String, GalleryMT20Item>  _selectedItems           = new HashMap<>();
