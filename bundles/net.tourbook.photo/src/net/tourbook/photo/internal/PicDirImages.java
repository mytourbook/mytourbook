...
//			_galleryToolbar.setBackground(bgColor);
   ...
   private void updateUI_Action_FolderGallery() {
      ...
      if (_isShowOnlyPhotos) {
         ...
         _actionToggleFolderGallery.setImageDescriptor(Activator.getImageDescriptor(Images.Image__PhotoFolderGallery_OnlyPhotos));
         ...
         _actionToggleFolderGallery.setImageDescriptor(Activator.getImageDescriptor(Images.Image__PhotoFolderGallery));
      }
