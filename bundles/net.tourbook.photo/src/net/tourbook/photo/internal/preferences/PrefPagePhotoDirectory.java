   ...
   private void createUI_10_Colors(final Composite parent) {
      ...
      group.setText(Messages.PrefPage_Photo_Viewer_Group_Colors);
      {
         ...
         GridDataFactory.fillDefaults().align(SWT.FILL, SWT.BEGINNING).applyTo(containerLeft);
         {
            ...
            addField(new ColorFieldEditor(
                  IPhotoPreferences.PHOTO_VIEWER_COLOR_SELECTION_BACKGROUND,
                  Messages.PrefPage_Theme_Dark_Label_SelectionBackgroundColor,
                  containerLeft));
         }
...
//      container.setBackground(Display.getCurrent().getSystemColor(SWT.COLOR_RED));
   ...
   protected void performDefaults() {
      ...
      _chkIsHighImageQuality.setSelection(_prefStore.getDefaultBoolean(IPhotoPreferences.PHOTO_VIEWER_IS_SHOW_IMAGE_WITH_HIGH_QUALITY));
      _spinnerThumbSize.setSelection(_prefStore.getDefaultInt(IPhotoPreferences.PHOTO_VIEWER_HIGH_QUALITY_IMAGE_MIN_SIZE));
      _spinnerTextMinThumbSize.setSelection(_prefStore.getDefaultInt(IPhotoPreferences.PHOTO_VIEWER_TEXT_MIN_THUMB_SIZE));
      _spinnerImageBorderSize.setSelection(_prefStore.getDefaultInt(IPhotoPreferences.PHOTO_VIEWER_IMAGE_BORDER_SIZE));
...
//      final String property = event.getProperty();
      ...
      if (source instanceof FieldEditor) {
         ...
         if (prefName.equals(IPhotoPreferences.PHOTO_VIEWER_COLOR_FOREGROUND)
               ...
               || prefName.equals(IPhotoPreferences.PHOTO_VIEWER_COLOR_SELECTION_BACKGROUND)
...
//      // TODO remove SYSTEM.OUT.PRINTLN
   ...
   private void restoreState() {
      ...
      _chkIsHighImageQuality.setSelection(_prefStore.getBoolean(IPhotoPreferences.PHOTO_VIEWER_IS_SHOW_IMAGE_WITH_HIGH_QUALITY));
      _spinnerThumbSize.setSelection(_prefStore.getInt(IPhotoPreferences.PHOTO_VIEWER_HIGH_QUALITY_IMAGE_MIN_SIZE));
      _spinnerTextMinThumbSize.setSelection(_prefStore.getInt(IPhotoPreferences.PHOTO_VIEWER_TEXT_MIN_THUMB_SIZE));
      _spinnerImageBorderSize.setSelection(_prefStore.getInt(IPhotoPreferences.PHOTO_VIEWER_IMAGE_BORDER_SIZE));
   ...
   private void saveState() {
      ...
      _prefStore.setValue(IPhotoPreferences.PHOTO_VIEWER_IS_SHOW_IMAGE_WITH_HIGH_QUALITY, _chkIsHighImageQuality.getSelection());
      _prefStore.setValue(IPhotoPreferences.PHOTO_VIEWER_HIGH_QUALITY_IMAGE_MIN_SIZE, _spinnerThumbSize.getSelection());
      _prefStore.setValue(IPhotoPreferences.PHOTO_VIEWER_TEXT_MIN_THUMB_SIZE, _spinnerTextMinThumbSize.getSelection());
      _prefStore.setValue(IPhotoPreferences.PHOTO_VIEWER_IMAGE_BORDER_SIZE, _spinnerImageBorderSize.getSelection());

      _prefStore.setValue(IPhotoPreferences.PHOTO_VIEWER_HQ_IMAGE_SIZE, PhotoLoadManager.HQ_IMAGE_SIZES[_comboHQImageSize.getSelectionIndex()]);
   }
