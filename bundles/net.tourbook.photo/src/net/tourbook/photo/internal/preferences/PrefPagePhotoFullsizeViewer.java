...
//				.spacing(0, 0)
	...
	private void fireModifyEvent() {
		...
		if (_isModified) {
			...
			getPreferenceStore().setValue(
					IPhotoPreferences.PHOTO_VIEWER_PREF_EVENT_FULLSIZE_VIEWER_IS_MODIFIED,
					Math.random());
		}
	}
	...
	private void restoreState() {
		...
		_chkThumbPreview.setSelection(//
				_prefStore.getBoolean(IPhotoPreferences.PHOTO_FULLSIZE_VIEWER_IS_SHOW_PREVIEW));

		_chkLoadingMessage.setSelection(//
				_prefStore.getBoolean(IPhotoPreferences.PHOTO_FULLSIZE_VIEWER_IS_SHOW_LOADING_MESSAGE));

		_chkHQImage.setSelection(//
				_prefStore.getBoolean(IPhotoPreferences.PHOTO_FULLSIZE_VIEWER_IS_SHOW_HQ_IMAGE));
	}
