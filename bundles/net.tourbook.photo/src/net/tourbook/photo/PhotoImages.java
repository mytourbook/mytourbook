...
public class PhotoImages {
   ...
   public static final String Photo_ShowAnnotation                = "photo-action-show-annotation.svg";           //$NON-NLS-1$
   public static final String PhotoAnnotation_Cropped             = "photo-annotation-cropped.svg";               //$NON-NLS-1$
   public static final String PhotoAnnotation_ExifGPS             = "photo-annotation-exif-gps.svg";              //$NON-NLS-1$
   public static final String PhotoAnnotation_Tonality            = "photo-annotation-tonality.svg";              //$NON-NLS-1$
   public static final String PhotoAnnotation_TourGPS             = "photo-annotation-tour-gps.svg";              //$NON-NLS-1$
   public static final String PhotoAnnotation_SavedInTour         = "photo-annotation-saved-in-tour.svg";         //$NON-NLS-1$
   public static final String PhotoAnnotation_SavedInTour_Hovered = "photo-annotation-saved-in-tour-hovered.svg"; //$NON-NLS-1$
   public static final String PhotoDirectoryView                  = "photo-directory.svg";                        //$NON-NLS-1$
   public static final String PhotoEnlargeSmallPhotos             = "photo-enlarge-small-photos.svg";             //$NON-NLS-1$
   public static final String PhotoFilter_GPS                     = "photo-filter-gps.svg";                       //$NON-NLS-1$
   ...
   public static final String PhotoRatingStar_Disabled            = "photo-rating-star-disabled.svg";             //$NON-NLS-1$
   public static final String PhotoRatingStar_Hovered             = "photo-rating-star-hovered.svg";              //$NON-NLS-1$
   public static final String PhotoRatingStar_NotHovered          = "photo-rating-star-not-hovered.svg";          //$NON-NLS-1$
   public static final String PhotoRatingStar_NotHovered_ButSet   = "photo-rating-star-not-hovered-but-set.svg";  //$NON-NLS-1$
