...
public class Camera implements Comparable<Camera> {
   ...
   /**
    * @return Returns time adjustment in ms
    */
   public long getTimeAdjustment() {
      return _timeAdjustment;
   }
   ...
   /**
    * Set time adjustment in ms
    *
    * @param timeAdjustment
    */
   public void setTimeAdjustment(final long timeAdjustment) {
      _timeAdjustment = timeAdjustment;
   }
