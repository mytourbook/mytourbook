...
public class ChartComponentGraph extends Canvas {
   ...
   ChartComponentGraph(final Chart chartWidget, final Composite parent, final int style) {
      ...
      _cursorModeSlider = createCursorFromImage(ChartImages.Image_cursor_mode_slider);
      _cursorModeZoom = createCursorFromImage(ChartImages.Image_cursor_mode_zoom);
      _cursorModeZoomMove = createCursorFromImage(ChartImages.Image_cursor_mode_zoom_move);
      _cursorDragXSlider_ModeZoom = createCursorFromImage(ChartImages.Image_Cursor_DragXSlider_ModeZoom);
      _cursorDragXSlider_ModeSlider = createCursorFromImage(ChartImages.Image_Cursor_DragXSlider_ModeSlider);
      _cursorHoverXSlider = createCursorFromImage(ChartImages.Image_Cursor_Hover_XSlider);

      _cursorMove1x = createCursorFromImage(ChartImages.Image_Cursor_Move1x);
      _cursorMove2x = createCursorFromImage(ChartImages.Image_Cursor_Move2x);
      _cursorMove3x = createCursorFromImage(ChartImages.Image_Cursor_Move3x);
      _cursorMove4x = createCursorFromImage(ChartImages.Image_Cursor_Move4x);
      _cursorMove5x = createCursorFromImage(ChartImages.Image_Cursor_Move5x);

      _cursorXSliderLeft = createCursorFromImage(ChartImages.Image_Cursor_X_Slider_Left);
      _cursorXSliderRight = createCursorFromImage(ChartImages.Image_Cursor_X_Slider_Right);
