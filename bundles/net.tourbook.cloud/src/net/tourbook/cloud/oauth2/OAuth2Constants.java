...
public class OAuth2Constants {
   ...
   public static final String PARAM_CLIENT_SECRET      = "client_secret";      //$NON-NLS-1$

   public static final String PARAM_CODE               = "code";               //$NON-NLS-1$

   public static final String PARAM_TOKEN              = "token";              //$NON-NLS-1$
   ...
   public static final String RESPONSE_TYPE            = "response_type";      //$NON-NLS-1$
}
