...
public class EntryRightBanner extends Composite {
    ...
    *           key tree
    */
   public EntryRightBanner(Composite parent,
...
//             && !editor.getMarkerManager().isDisposed()) {
            ...
            Collection<IMessageCheck> checks = editor.getMarkers().getFailedChecks(key, locale);
...
//       }
   ...
   private Action getCheckAction(String key,
                                 IMessageCheck check) {
      ...
      if (check instanceof MissingValueCheck) {
         ...
         return new ShowDuplicateAction(((DuplicateValueCheck) check).getDuplicateKeys(), key, locale);
      }
