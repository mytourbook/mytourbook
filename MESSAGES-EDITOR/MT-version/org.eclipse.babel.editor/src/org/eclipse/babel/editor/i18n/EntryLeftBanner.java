...
public class EntryLeftBanner extends Composite {
    ...
    *           key tree
    */
   public EntryLeftBanner(Composite parent,
...
//        commentButton.setImage(UIUtils.getImage("comment.gif"));
      ...
      _font = UIUtils.createFont(localeLabel, SWT.BOLD);
      localeLabel.setFont(_font);
      ...
      localeLabel.setToolTipText(MessagesEditorPlugin.getString("editor.i18nentry.resourcelocation", i18NEntry.getResourceLocationLabel())); //$NON-NLS-1$
   ...
   private Image loadCountryIcon(Locale countryLocale) {
      ...
      if (countryCode != null && countryCode.length() > 0) {
         ...
         String imageName = "countries/" + countryCode.toLowerCase() + ".gif"; //$NON-NLS-1$
