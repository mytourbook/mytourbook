...
//   private static final String   SYSTEM_LINE_SEP    = System.getProperty("line.separator");
   ...
   /** System line separator. */
//   private static final String   SYSTEM_LINE_SEP    = Platform.getPreferencesService().getString(
//
//         // qualifier
...
//         null);
   ...
   static {
      ...
      FORCED_LINE_SEP[IPropertiesSerializerConfig.NEW_LINE_MAC] = "\\\\r";
   }
...
//        text.append(key);
   ...
   public String serialize(final MessagesBundle messagesBundle) {
      ...
      final String systemLineBreak = SYSTEM_LINE_SEP;
