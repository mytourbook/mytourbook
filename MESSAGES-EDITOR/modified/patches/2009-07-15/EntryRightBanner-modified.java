...
public class EntryRightBanner extends Composite {
    ...
    private Action getCheckAction(
            final String key, final IMessageCheck check) {
...
//                        && !editor.getMarkerManager().isDisposed()) {
                    ...
                    final String key = editor.getSelectedKey();
                    final Collection<IMessageCheck> checks = editor.getMarkers().getFailedChecks(
                            key, locale);
