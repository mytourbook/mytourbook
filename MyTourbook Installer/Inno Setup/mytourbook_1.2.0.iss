[Setup]
AppName=MyTourbook
AppVerName=MyTourbook 1.2.0
AppCopyright=MyTourbook Contributors 2005, 2007
AppID={{37852811-BC7D-411C-8122-E69CCA892582}

LicenseFile=M:\mytourbook TRUNK\net.tourbook\gpl.txt

OutputDir=m:\MyTourbook Product\1.2.0
OutputBaseFilename=mytourbook_1.2.0.win32.win32.x86.setup
...
[Files]
Source: m:\MyTourbook Product\1.2.0\mytourbook_1.2.0.win32.win32.x86\mytourbook\*; DestDir: {app}; Flags: recursesubdirs; Tasks: ; Languages:
