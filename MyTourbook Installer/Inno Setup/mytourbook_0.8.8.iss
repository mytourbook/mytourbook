...
OutputDir=F:\MyTourbook Product\0.8.8
OutputBaseFilename=mytourbook_0.8.8.win32_setup
...
[Files]
Source: F:\MyTourbook Product\0.8.8\mytourbook_0.8.8.win32.win32.x86\mytourbook\*; DestDir: {app}; Flags: recursesubdirs; Tasks: ; Languages: 
